...
entirely – it's up to you. In any case, make sure that at the outset you clearly state goals ( "objectives" )
for your project.
...
networks are used is pattern classification (static or temporal patterns), a supervised learning task.
...
search.
Besides classification (of static or temporal patterns), timeseries prediction is another standard
...
technical writing, not the accuracy or otherwise measurable performance level of your final results. A
...
lines max ) specifying your project title and the modeling task that you have chosen, and post this as a
...
The short abstract of your chosen project, to be posted in your Nestor group: deadline May 17
...
The final project report: deadline June 21, 23:59:59 hrs. This is a hard deadline. Every day of
...
Consider this report more of a lab report than a scientific paper. Specifically, you do not have to do a
...
A title page, including a list of team members
A separate page with an abstract (10 lines) and a table of contents
Introduction : a statement of given or self-chosen task, including a description of the dataset used.
You do not need to write a scientific-paper style introduction with an outline of scientific
...
Data : Describe the dataset that you are using. The reader should get a good intuitive grasp on them
best achieved by graphical representations.
Methods: This is the main technical part of the report. You describe all steps in the processing
...
Results: Document the results of your final optimized architecture (also, if that is of interest, results
of other architecture versions that you tried).
Discussion: what you learnt, why you think some things didn't work, what potential you see for
...
where f is any sigmoid-shaped function and x is the normalized network state. "
...
the number N in the main text! When you want to use bold font math symbols (for instance, for
...
NEVER reprint original program code in scientific writing. Instead, provide pseudocode descriptions
